            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {property.latitude && property.longitude && (
                ...
                >
                  ...
                  <Suspense
                    fallback={
                      <div className="w-full h-[300px] md:h-[400px] rounded-xl bg-[#F5F3EF] animate-pulse flex items-center justify-center">
                        <svg className="w-8 h-8 text-[#B8926A] opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <PropertyMap
                      ...
                      title={getTranslated(locale, property.title, property.titleTranslations)}
              ...
              <div className="sticky top-24 space-y-6">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    {/* WhatsApp Button */}
                    <a
                      href={`https://wa.me/${property.agent.phone.replace(/[^0-9+]/g, "").replace("+", "")}?text=${encodeURIComponent(
                        `Hi, I'm interested in this property: ${getTranslated(locale, property.title, property.titleTranslations)} - https://xact.lu/properties/${property.slug}`
                      )}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full h-12 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-xl font-medium transition-colors"
                    >
