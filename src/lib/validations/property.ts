...
export const propertySchema = z.object({
  ...
  titleTranslations: z.record(z.string(), z.string()).nullable().optional(),
  descriptionTranslations: z.record(z.string(), z.string()).nullable().optional(),
  ...
  energyClass: z.string().nullable().optional().default(""),
  heatingType: z.string().nullable().optional().default(""),
  address: z.string().min(1, "Address is required"),
  city: z.string().min(1, "City is required"),
  postalCode: z.string().nullable().optional().default(""),
