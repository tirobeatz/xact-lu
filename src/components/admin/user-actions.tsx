        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-[#E8E6E3] py-1 z-20">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-[#1A1A1A] hover:bg-[#F5F3EF] w-full"
            >
              {user.isVerified ? (
                <>
            ...
            {/* Role Changes */}
            <p className="px-4 py-1 text-xs text-[#6B6B6B] uppercase">Change Role</p>
            ...
            {user.role !== "AGENCY_OWNER" && (
              <button
                onClick={() => updateRole("AGENCY_OWNER")}
                className="flex items-center gap-2 px-4 py-2 text-sm text-[#1A1A1A] hover:bg-[#F5F3EF] w-full"
              >
